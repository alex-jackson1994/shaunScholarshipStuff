#!/usr/bin/env python3
#This script combines every chromosome/contig in a FASTA format file into a single chromosome
#The bash script 'combineFastaChunks.sh' does the exact same thing about an order of magnitude faster, use that instead
import sys
